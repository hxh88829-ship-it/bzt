...
func (x *Chain) GetMongoUrl() string {
	if x != nil {
		return x.MongoUrl
	}
	return ""
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\x05chain\x18\x03 \x01(\v2\x11.kratos.api.ChainR\x05chain\"\xb8\x02\n" +
	"\x06Server\x12+\n" +
	...
	"\x05Chain\x12\x1b\n" +
	"\tmongo_url\x18\x01 \x01(\tR\bmongoUrlB\x1fZ\x1dvalueguard/internal/conf;confb\x06proto3"
